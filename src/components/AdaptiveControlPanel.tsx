                  ...
                  <div className="flex items-center gap-2">
                    {isAuthenticated ? (
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-3 py-1.5 bg-theme-button text-theme-button text-sm rounded-lg transition-colors hover:bg-theme-button border border-gray-900 dark:border-gray-600"
                      >
