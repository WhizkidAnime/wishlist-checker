          ...
          <>
            {isMobile ? (
              ...
              <Portal>
                ...
                />
                  <div 
                    className="fixed bg-theme-card border border-theme-border rounded-xl shadow-lg py-2 px-2 min-w-64 z-[99999]"
                    style={{ 
                      top: '80px',
                      right: '16px'
                    }}
                  ...
                  <button
                    ...
                    className="w-full my-1 px-3 py-2 text-left text-sm text-theme-primary hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors flex items-center gap-2"
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M13.5 6.5h3a3 3 0 010 6h-3"/><path d="M10.5 17.5h-3a3 3 0 010-6h3"/><path d="M8 12h8"/></svg>
                  ...
                  */}
                  ...
                  <button
                    ...
                    className="w-full my-1 px-3 py-2 text-left text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors flex items-center gap-2"
                  >
                    Выйти
                  </button>
                </div>
              ...
              <div className="absolute right-0 top-full mt-2 bg-theme-card border border-theme-border rounded-xl shadow-lg py-2 px-2 min-w-64 z-50">
                <div className="px-4 py-2 border-b border-theme-border">
                  <div className="text-sm font-medium text-theme-primary truncate">
                    {user?.email}
                  </div>
